      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6 text-lg leading-relaxed">
            <strong>BIOS (Business Information Organization Students)</strong>{" "}
            adalah Himpunan Mahasiswa Program Studi Sistem Informasi di
            Universitas Bunda Mulia. Kami berkomitmen untuk menjadi wadah
            pengembangan diri mahasiswa dalam bidang teknologi informasi dan
            bisnis.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center bg-black text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition-all duration-200"
            >
              <span className="mr-2">🎵</span>
              TikTok
            </a>
